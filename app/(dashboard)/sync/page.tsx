...
export default function SyncPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Run Sync</h1>
        <p className="text-gray-500">Synchronize items between Notion and Azure DevOps</p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {directionOptions.map((option) => (
              ...
              >
                <option.icon className={`h-6 w-6 mb-2 ${direction === option.value ? 'text-blue-600' : 'text-gray-500'}`} />
